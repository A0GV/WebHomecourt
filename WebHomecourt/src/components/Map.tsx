...
export default function Map() {
  ...
  return (
    <section className="w-full max-w-[1120px] rounded-3xl overflow-hidden border border-[#e7e6e8] bg-[#f3f2f5] shadow-[0_28px_52px_rgba(35,17,61,0.3)]">
      
      {/* Topbar */}
      <header className="flex flex-wrap items-center justify-center sm:justify-between gap-3 px-6 py-[18px] bg-[#3b195c] border-b border-[#e7e6e8] text-[#f3f2f3]">
        <p className="flex items-center gap-[10px] text-[0.95rem] font-bold tracking-[0.08em] m-0">
        ...
        <div className="flex items-center gap-[10px]">
          <button
            type="button"
            className="border-0 rounded-full px-5 py-[10px] text-[0.95rem] font-semibold text-[#e7e6e8] bg-[#7e57d7] shadow-[0_10px_18px_rgba(20,10,44,0.35)] cursor-pointer"
          >
            Satellite
          </button>
          <button
            type="button"
            className="border-0 rounded-full px-5 py-[10px] text-[0.95rem] font-semibold text-[rgba(169,157,182,0.83)] bg-[rgba(147,130,164,0.64)] cursor-pointer"
          >
            List
          </button>
        </div>
      ...
      <div className="relative isolate">
        ...
        <MapContainer
          ...
          zoom={13}
          className="w-full h-[560px] md:h-[460px] sm:h-[360px] hc-map-canvas"
          ref={setMap}
        >
          <TileLayer
        ...
        {/* City chip */}
        <div className="absolute z-[500] top-6 left-7 rounded-[14px] border border-[rgba(84,37,129,0.5)] px-[18px] py-3 text-[#f3f2f3] text-[1.02rem] font-bold backdrop-blur-sm bg-[rgba(59,25,92,0.9)] shadow-[0_14px_24px_rgba(29,13,52,0.35)] sm:top-[14px] sm:left-[14px] sm:text-[0.95rem] sm:px-[14px] sm:py-[10px]">
          {currentCity}
        </div>
        ...
        <button
          ...
          type="button"
          className="absolute z-[500] left-7 bottom-6 rounded-[14px] border border-[rgba(148,130,165,0.3)] px-[18px] py-3 text-[#f3f2f3] text-[1.02rem] font-bold backdrop-blur-sm bg-[#542581] shadow-[0_14px_24px_rgba(29,13,52,0.35)] sm:left-[14px] sm:bottom-[14px] sm:text-[0.95rem] sm:px-[14px] sm:py-[10px] cursor-pointer"
        >
          My Location
        </button>
      </div>
      ...
      {/* Courts strip */}
      <div className="flex items-center gap-3 overflow-x-auto px-5 py-4 border-t border-[#e7e6e8] bg-[#f3f2f5] [scrollbar-width:thin] [&::-webkit-scrollbar]:h-[7px] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[rgba(82,47,134,0.35)]">
        {courts.length > 0 ? (
          courts.map((court) => (
            <button
              key={court.court_id}
              ...
              className={[
                ...
                "sm:text-[0.94rem] sm:px-4 sm:py-[10px]",
